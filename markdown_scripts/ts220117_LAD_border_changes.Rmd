...
point that CTCF and cohesin are not involved in LAD border positioning. Or to
which extent they are.
...
Then, I will plot the distance to the nearest border. However, I want to
determine whether the border is displaced. If the entire LAD is lost, the 
nearest border will be "wrong". To prevent this, I will only look in a 100 kb
window from the parental border, and disregard nearest borders that are further
away than that. 

In this way, I can specifically ask whether CTCF depletion (or any other 
depletion) results in a shift of the LAD border. Perhaps not ideal, but 
together with previous analyses of average signal at LAD borders, it should
be a convincing analysis. I hope.
...
This looks sort of as expected. Looks good. I can use these figures in the
manuscript.
